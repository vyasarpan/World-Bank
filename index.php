      ...
      <span class="navbar-toggler-icon" style="background:white;"></span>
       ...
       <div class="collapse navbar-collapse text-center" id="collapsenavbar">
          <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a href="transfermoney.php" class="nav-link text-white"> AMOUNT DETAILS </DETAILS></DEtails></a></li>
              <li class="nav-item">
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <img src="world.png" class="img-fluid" width="560" height="345" style="margin-top:20px;">
